...
The system is built with an end-to-end ML pipeline covering preprocessing, inference, and evaluation, and is deployed using Streamlit for interactive exploration.
